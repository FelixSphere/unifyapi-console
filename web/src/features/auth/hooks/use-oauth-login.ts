...
export function useOAuthLogin(
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      await resetSession()
      const state = await createOAuthFlow('github', 'login', partnership)
  ...
  const handleDiscordLogin = async () => {
    ...
    try {
      await resetSession()
      const state = await createOAuthFlow('discord', 'login', partnership)
  ...
  const handleOIDCLogin = async () => {
    ...
    try {
      await resetSession()
      const state = await createOAuthFlow('oidc', 'login', partnership)
  ...
  const handleLinuxDOLogin = async () => {
    ...
    try {
      await resetSession()
      const state = await createOAuthFlow('linuxdo', 'login', partnership)
  ...
  const handleCustomOAuthLogin = async (provider: CustomOAuthProviderInfo) => {
    ...
    try {
      await resetSession()
      const state = await createOAuthFlow(provider.slug, 'login', partnership)
