...
type RelayInfo struct {
	...
	// UNIFYAPI: set when the outbound Claude request carries output_format, so
	// the adaptor knows to ask for the beta that makes it take effect.
	ClaudeStructuredOutputs   bool
