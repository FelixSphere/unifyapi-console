...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/test/:id/video", permission: authz.ChannelOperate, handler: controller.SubmitChannelVideoTest},
	{method: http.MethodGet, path: "/test/:id/video/:task_id", permission: authz.ChannelOperate, handler: controller.FetchChannelVideoTest},
