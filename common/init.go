...
func InitEnv() {
	...
	SetMaxConcurrentRelays(int64(GetEnvOrDefault("RELAY_MAX_CONCURRENT", 0)))
	...
	SessionRateLimitEnable = GetEnvOrDefaultBool("SESSION_RATE_LIMIT_ENABLE", true)
	SessionRateLimitNum = GetEnvOrDefault("SESSION_RATE_LIMIT", 120)
	SessionRateLimitDuration = int64(GetEnvOrDefault("SESSION_RATE_LIMIT_DURATION", 300))
