...
type Task struct {
	...
	Group      string                `json:"group" gorm:"type:varchar(255)"` // 修正计费用
...
type TaskPrivateData struct {
	...
	BillingSource       string              `json:"billing_source,omitempty"`        // wallet/subscription/promotional
	SubscriptionId      int                 `json:"subscription_id,omitempty"`       // 订阅 ID，用于订阅退款
	CreditReservationId int                 `json:"credit_reservation_id,omitempty"` // Promotional reservation for async adjustments/refunds.
...
type TaskBillingContext struct {
	...
	UserGroup       string             `json:"user_group,omitempty"`        // UNIFYAPI-FORK: request-time customer/company
